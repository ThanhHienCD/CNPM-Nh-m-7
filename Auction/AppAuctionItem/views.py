...
def all_item(request,category_slug=None):
    ...
    return render(request,'AppAuction/all_item.html',context)
...
def single_item(request,item_id,slug):
    ...
    return render(request,'AppAuction/single_item.html',context)
...
def search(request,category_slug=None):
    ...
    return render(request,'AppAuction/search.html',context)
...
def contact_submit(request):
    if request.method =='POST':
        ...
        send_mail(
            lot,
                message,
                'caoquocduydualeo@gmail.com',
                [email,'caoquocduydualeo@gmail.com'],#'sukhadamorgaonkar28@gmail.com','chetna.nihalani@yahoo.in'],
        )
