...
from AppAuctionItem.models import Contact,Wishlist
...
def register(request):
    ...
    return render(request,'AppAuction/register.html')
...
def login(request):
    if request.method == "POST":
        ...
        return render(request,'AppAuction/login.html')
def logout(request):
    if request.method == 'POST':
        auth.logout(request)
...
def dashboard(request):
    ...
    return render(request,'AppAuction/dashboard.html',context)
...
def wishlist(request):
    ...
    return render(request,'AppAuction/wishlist.html',context)