...
def post_list(request,tag_slug=None):
    ...
    return render(request,'AppAuction/blog_list.html',context)
...
def post_detail(request,year,month,day,post):
    ...
    return render(request,'AppAuction/blog_details.html',{'post':post,
                                               'tags':tags,
...
def post_share(request,post_id):
    ...
    if request.method =='POST':
        ...
        if form.is_valid():  #see forms.errors 
            ...
            send_mail(subject,message,'caoquocduydualeo@gmail.com',
                      [cleaned_data['to']])
            sent=True
    else:
        #not a post request
    ...
    return render(request,'AppAuction/share.html',context)
...
def post_search(request):
    ...
    if 'search_post' in request.GET:
        ...
        queryset_post=None
    return render(request,'AppAuction/search_post.html', { 'ql_post':queryset_post } )